  ...
  return (
    <S.Container>
      <S.FooterBtn href="#header">
        <S.FooterBtnContent>Back to top</S.FooterBtnContent>
      </S.FooterBtn>
      <S.Table>
        <Row margin="0" lg={4} sm={2}>
          <Column padding="10px 50px 0">
            <S.Cell>
              <S.CellHead>Get to Know Us</S.CellHead>
              <S.CellList>
          ...
          <Column padding="10px 50px 0">
            <S.Cell>
              <S.CellHead>Make Money with Us</S.CellHead>
              <S.CellList>
            ...
            <S.BtnContainer>
              <Link to="#">
                <S.BtnsContent>
                  <S.EarthIcon
                    position="-77px -24px"
                    url="https://m.media-amazon.com/images/G/01/AUIClients/InternationalCustomerPreferencesNavAssets-icp_sprite-7285cab5f8342a9a80f19b7ae5b155f77772ffc6._V2_.png"
                  />
